...
categories = ['Товары для детей', 'Обучение', 'Дом и ремонт', 'Еда и продукты',
       'Услуги и сервис', 'Аптеки и медицина',
       'Одежда, обувь, аксессуары', 'Книги, кино, искусство',
       'Путешествия', 'Электроника', 'Ювелирные изделия и часы',
       'Кафе, бары и рестораны', 'Авто', 'Цветы и подарки',
       'Такси и каршеринг', 'Товары для животных']
